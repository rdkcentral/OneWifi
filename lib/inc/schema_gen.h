...
#define PJS_SCHEMA_Wifi_Global_Config \
    PJS(schema_Wifi_Global_Config, \
        ...
        PJS_OVS_INT(rss_mem_threshold1) \
        PJS_OVS_INT(rss_mem_threshold2) \
...
#define SCHEMA_COLUMN__Wifi_Global_Config(COLUMN) \
    ...
    COLUMN(rss_mem_threshold1) \
    COLUMN(rss_mem_threshold2) \
...
#define SCHEMA__Wifi_Global_Config__threshold1 "rss_mem_threshold1"
#define SCHEMA__Wifi_Global_Config__threshold2 "rss_mem_threshold2"
