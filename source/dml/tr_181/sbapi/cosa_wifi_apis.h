...
typedef  enum
_COSA_DML_WIFI_MULTI_LINK_MODES
{
       COSA_DML_WIFI_MULTI_LINK_MODE_STR        = 0x1,
       COSA_DML_WIFI_MULTI_LINK_MODE_NSTR       = 0x2,
       COSA_DML_WIFI_MULTI_LINK_MODE_EMLSR      = 0x4,
       COSA_DML_WIFI_MULTI_LINK_MODE_EMLMR      = 0x8,
}
COSA_DML_WIFI_MULTI_LINK_MODES, *PCOSA_DML_WIFI_MULTI_LINK_MODES;
