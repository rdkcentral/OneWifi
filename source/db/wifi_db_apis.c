    ...
    struct schema_Wifi_Rfc_Config *new_rec)
{
    ...
    if (mon->mon_type == OVSDB_UPDATE_DEL) {
        ...
        rfc_param->wei_rfc = new_rec->wei_rfc;
	    ...
	    "wei_rfc=%d \r\n",
            ...
            rfc_param->xfi_tel_enable_rfc, rfc_param->multiap_rfc,rfc_param->wei_rfc);
