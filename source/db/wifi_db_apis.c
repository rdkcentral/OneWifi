        ...
        struct schema_Wifi_Global_Config *new_rec)
{
    ...
    else if ((mon->mon_type == OVSDB_UPDATE_NEW) || (mon->mon_type == OVSDB_UPDATE_MODIFY))
    {
        ...
        g_wifidb->global_config.global_parameters.rss_mem_threshold1 = new_rec->rss_mem_threshold1;
        g_wifidb->global_config.global_parameters.rss_mem_threshold2 = new_rec->rss_mem_threshold2;
...
int wifidb_update_wifi_global_config(wifi_global_param_t *config)
{
    ...
    cfg.rss_mem_threshold1 = config->rss_mem_threshold1;
    cfg.rss_mem_threshold2 = config->rss_mem_threshold2;
...
int wifidb_get_wifi_global_config(wifi_global_param_t *config)
{
    ...
    else
    {
        ...
        config->rss_mem_threshold1 = pcfg->rss_mem_threshold1;
        config->rss_mem_threshold2 = pcfg->rss_mem_threshold2;
...
static void wifidb_global_config_upgrade()
{
    ...
    if( g_wifidb->db_version < ONEWIFI_RSS_MEMORY_THRESHOLD_FLAG) {
        wifi_util_dbg_print(WIFI_DB, "%s:%d upgrade global config, old db version %d \n", __func__, __LINE__, g_wifidb->db_version);
        g_wifidb->global_config.global_parameters.rss_mem_threshold1 = RSS_MEM_THRESHOLD1_DEFAULT;
        g_wifidb->global_config.global_parameters.rss_mem_threshold2 = RSS_MEM_THRESHOLD2_DEFAULT;
        }
}
...
int wifidb_init_global_config_default(wifi_global_param_t *config)
{
    ...
    cfg.rss_mem_threshold1 = 81920;
    cfg.rss_mem_threshold2 = 112640;
