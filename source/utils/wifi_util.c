...
//CC: US, Band 2.4G
wifi_operating_classes_t us_24G[] = {
    {81, -30,  2, {12,13}},
    {83, -30, 0, {}},
    {84, -30, 2, {12,13}},
};
...
//CC: US, Band 5G
wifi_operating_classes_t us_5G[] = {
    {115, -30, 0, {}},
    {116, -30, 0, {}},
    {117, -30, 0, {}},
    {118, -30, 0, {}},
    ...
    {126, -30, 0, {}},
    {127, -30, 1, {169}},
    {128, -30, 0, {}},  //TBD: Example indicates nonOperable as [106, 122, 138, 155], in singleAp.json [42,58]
    {129, -30, 0, {}},  //TBD: Example indicated nonOperable as [50] in singleAp.json
    {130, -30, 0, {}},  //TBD: Example indicates nonOperable as [106, 122, 138, 155], in singleAp.json [42,58]
};

//CC: US, Band 6G
wifi_operating_classes_t us_6G[] = {
    {131, 23, 0, {}},
    {132, 23, 0, {}},
    {133, 23, 0, {}},
    {134, 23, 0, {}},
...
//CC: EU, Band 2.4G
wifi_operating_classes_t eu_24G[] = {
    {81, -30,  0, {}},
    {83, -30, 0, {}},
    {84, -30, 0, {}},
};
...
//CC: EU, Band 5G
wifi_operating_classes_t eu_5G[] = {
    {115, -30, 0, {}},
    {116, -30, 0, {}},
    {117, -30, 0, {}},
    {118, -30, 0, {}},
    ...
    {123, -30, 0, {}},
    {125, -30, 1, {173}},
    {128, -30, 2, {138,155}},   //TBD: Example indicates nonOperable as [106, 122, 138, 155], in singleAp.json [42,58]
    {129, -30, 0, {}},          //TBD: Example indicated nonOperable as [50] in singleAp.json
    {130, -30, 2, {138,155}},   //TBD: Example indicates nonOperable as [106, 122, 138, 155], in singleAp.json [42,58]
};

//CC: EU, Band 6G TBD: Revisit if different from US
wifi_operating_classes_t eu_6G[] = {
    {131, 23, 0, {}},
    {132, 23, 0, {}},
    {133, 23, 0, {}},
    {134, 23, 0, {}},
...
//CC: JP, Band 2.4G
wifi_operating_classes_t jp_24G[] = {
    {81, -30,  0, {}},
    {83, -30, 0, {}},
    {84, -30, 0, {}},
};
...
//CC: JP, Band 5G
wifi_operating_classes_t jp_5G[] = {
    {115, -30, 0, {}},
    {116, -30, 0, {}},
    {117, -30, 0, {}},
    {118, -30, 0, {}},
    ...
    {122, -30, 0, {}},
    {123, -30, 0, {}},
    {128, -30, 1, {155}},       //TBD: Example indicates nonOperable as [106, 122, 138, 155], in singleAp.json [42,58]
    {129, -30, 0, {}},          //TBD: Example indicated nonOperable as [50] in singleAp.json
    {130, -30, 1, {155}},       //TBD: Example indicates nonOperable as [106, 122, 138, 155], in singleAp.json [42,58]
};

//CC: JP, Band 6G TBD: Revisit if different from US
wifi_operating_classes_t jp_6G[] = {
    {131, 23, 0, {}},
    {132, 23, 0, {}},
    {133, 23, 0, {}},
    {134, 23, 0, {}},
...
//CC: CN, Band 2.4G
wifi_operating_classes_t cn_24G[] = {
    {81, -30,  0, {}},
    {83, -30, 0, {}},
    {84, -30, 0, {}},
};
...
//CC: CN, Band 5G
wifi_operating_classes_t cn_5G[] = {
    {115, -30, 0, {}},
    {116, -30, 0, {}},
    {118, -30, 0, {}},
    {119, -30, 0, {}},
    {125, -30, 2, {169,173}},
    {126, -30, 1, {165}},
    {128, -30, 3, {106,122,138}},   //TBD: Example indicates nonOperable as [106, 122, 138, 155], in singleAp.json [42,58]
    {129, -30, 1, {114}},           //TBD: Example indicated nonOperable as [50] in singleAp.json
    {130, -30, 3, {106,122,138}},   //TBD: Example indicates nonOperable as [106, 122, 138, 155], in singleAp.json [42,58]
};

//CC: CN, Band 6G TBD: Revisit if different from US
wifi_operating_classes_t cn_6G[] = {
    {131, 23, 0, {}},
    {132, 23, 0, {}},
    {133, 23, 0, {}},
    {134, 23, 0, {}},
...
//CC: others, Band 2.4G
wifi_operating_classes_t others_24G[] = {
    {81, -30,  0, {}},
    {83, -30, 0, {}},
    {84, -30, 0, {}},
};
...
//CC: others, Band 5G
wifi_operating_classes_t others_5G[] = {
    {115, -30, 0, {}},
    {116, -30, 0, {}},
    {117, -30, 0, {}},
    {118, -30, 0, {}},
...
//CC: others, Band 6G TBD: Revisit if different from US
wifi_operating_classes_t others_6G[] = {
    {131, 23, 0, {}},
    {132, 23, 0, {}},
    {133, 23, 0, {}},
    {134, 23, 0, {}},
...
wifi_region_t get_region_from_countrycode(wifi_countrycode_type_t countryCode) {
    ...
    if (countryCode > wifi_countrycode_ZW) {
        wifi_util_dbg_print(WIFI_CTRL,"%s:%d: Error, Countrycode %d not known.\n",
            __func__, __LINE__, countryCode);
...
int update_radio_operating_classes(wifi_radio_operationParam_t *oper)
{
    ...
    wifi_operating_classes_t *operatingClassesToCopy = NULL;
    int numOperatingClasses = 0;

    wifi_util_dbg_print(WIFI_CTRL,"%s:%d: Invoked.\n",__func__, __LINE__);
    ...
    if (oper->band == WIFI_FREQUENCY_2_4_BAND) {
        switch (region) {
            case wifi_region_US:
                operatingClassesToCopy = us_24G;
                numOperatingClasses = ARRAY_SIZE(us_24G);
                break;
            case wifi_region_EU:
                operatingClassesToCopy = eu_24G;
                numOperatingClasses = ARRAY_SIZE(eu_24G);
                break;
            case wifi_region_JP:
                operatingClassesToCopy = jp_24G;
                numOperatingClasses = ARRAY_SIZE(jp_24G);
                break;
            case wifi_region_CN:
                operatingClassesToCopy = cn_24G;
                numOperatingClasses = ARRAY_SIZE(cn_24G);
                break;
            case wifi_region_other:
                operatingClassesToCopy = others_24G;
                numOperatingClasses = ARRAY_SIZE(others_24G);
                break;
            default:
                return RETURN_ERR;
        }
    } else if(oper->band == WIFI_FREQUENCY_5_BAND ||
              oper->band == WIFI_FREQUENCY_5H_BAND ||
              oper->band == WIFI_FREQUENCY_5L_BAND) {
        switch (region) {
            case wifi_region_US:
                operatingClassesToCopy = us_5G;
                numOperatingClasses = ARRAY_SIZE(us_5G);
                break;
            case wifi_region_EU:
                operatingClassesToCopy = eu_5G;
                numOperatingClasses = ARRAY_SIZE(eu_5G);
                break;
            case wifi_region_JP:
                operatingClassesToCopy = jp_5G;
                numOperatingClasses = ARRAY_SIZE(jp_5G);
                break;
            case wifi_region_CN:
                operatingClassesToCopy = cn_5G;
                numOperatingClasses = ARRAY_SIZE(cn_5G);
                break;
            case wifi_region_other:
                operatingClassesToCopy = others_5G;
                numOperatingClasses = ARRAY_SIZE(others_5G);
                break;
            default:
                return RETURN_ERR;
        }
        ...
        switch (region) {
            case wifi_region_US:
                operatingClassesToCopy = us_6G;
                numOperatingClasses = ARRAY_SIZE(us_6G);
                break;
            case wifi_region_EU:
                operatingClassesToCopy = eu_6G;
                numOperatingClasses = ARRAY_SIZE(eu_6G);
                break;
            case wifi_region_JP:
                operatingClassesToCopy = jp_6G;
                numOperatingClasses = ARRAY_SIZE(jp_6G);
                break;
            case wifi_region_CN:
                operatingClassesToCopy = cn_6G;
                numOperatingClasses = ARRAY_SIZE(cn_6G);
                break;
            case wifi_region_other:
                operatingClassesToCopy = others_6G;
                numOperatingClasses = ARRAY_SIZE(others_6G);
                break;
            default:
                return RETURN_ERR;
        }
    } else {
        wifi_util_dbg_print(WIFI_CTRL,"%s:%d: Error, Unknown band: %d.\n",__func__, __LINE__, oper->band);
        return RETURN_ERR;
    }
    memcpy(oper->operatingClasses, operatingClassesToCopy, sizeof(wifi_operating_classes_t)*numOperatingClasses);
    oper->numOperatingClasses = numOperatingClasses;
    wifi_util_dbg_print(WIFI_CTRL,"%s:%d: Copied %d operating classes.\n",
        __func__, __LINE__, oper->numOperatingClasses);
