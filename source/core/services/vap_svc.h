...
#define STA_CONN_RETRY_TIMEOUT                 9 //15 seems to trigger watchdog
#define STA_MAX_CONNECT_ATTEMPT                2
#define STA_MAX_DISCONNECT_ATTEMPT             2
#define MAX_SCAN_RESULT_WAIT                   2 //tested 5
// max connection algoritham timeout 4 minutes
#define MAX_CONNECTION_ALGO_TIMEOUT            4 * 60
#define EXT_CONNECT_ALGO_PROCESSOR_INTERVAL    1000 //tested 20s 

#define EXT_SCAN_RESULT_TIMEOUT                4000
#define EXT_SCAN_RESULT_WAIT_TIMEOUT           4000 //tested 9000
#define EXT_CONN_STATUS_IND_TIMEOUT            5000 //tested 10000
