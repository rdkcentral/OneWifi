...
void process_csa_beacon_frame_event(frame_data_t *msg, uint32_t msg_length)
{
    wifi_ctrl_t *ctrl;
    bus_error_t rc;
    ...
    wifi_event_subtype_t subtype)
{
	...
	wifi_util_dbg_print(WIFI_CTRL, "%s:%d Processing CSA beacon frame\n", __func__, __LINE__);
        process_csa_beacon_frame_event(data, len);
        break;
