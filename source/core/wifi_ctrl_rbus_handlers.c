...
/*
 * *** notify_LM_Lite_host msg format: ***
 *
 * CONFIG_MLO_ENABLED_NOTIFY_LM_LITE disabled:
 * phyAddr,AssociatedDevice,ssid,RSSI,Status
 * - phyAddr: MAC address of the associated device
 * - AssociatedDevice: associated device references to DM
 * - ssid: SSID of the associated device - references to DM
 * - RSSI: RSSI value of the associated device
 * - Status: Status of the associated device
 *
 * CONFIG_MLO_ENABLED_NOTIFY_LM_LITE enabled:
 * phyAddr,[AssociatedDevice],[ssid],[RSSI],Status,mld_sta
 * - phyAddr: MLD MAC address of the associated device
 * - AssociatedDevice - references to DM:
 *     For MLO device: List of associated DM references for all links separated by ';'
 *     For non MLO device: it contain single associated device reference.
 * - ssid - references to DM:
 *     For MLO Device: List of SSIDs for all links used for connection, separated by';'
 *     For non MLO device, it contain single SSID.
 * - RSSI:
 *      For MLO Device: List of RSSI values for all links used for connection, separated by ';'
 *      For non MLO device, it contain single RSSI value.
 * - Status: Status of the associated device
 * - mld_sta: MLD status of the associated device
 * Example:
