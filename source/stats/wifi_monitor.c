...
int increment_reason_count(interop_data_t *telemetry, wifi_reason_code_t code, int ap) {
    //wifi_util_dbg_print(WIFI_MON, "%s:%d station_reason_counts=[%d:%d:%d:%d:%d:%d:%d:%d:%d:%d] ap_reason_counts=[%d:%d:%d:%d:%d:%d:%d:%d:%d:%d]\n",__FUNCTION__,__LINE__,telemetry->sta_reason_counts[0],telemetry->sta_reason_counts[1],telemetry->sta_reason_counts[2],telemetry->sta_reason_counts[3],telemetry->sta_reason_counts[4],telemetry->sta_reason_counts[5],telemetry->sta_reason_counts[6],telemetry->sta_reason_counts[7],telemetry->sta_reason_counts[8],telemetry->ap_reason_counts[0],telemetry->ap_reason_counts[1],telemetry->ap_reason_counts[2],telemetry->ap_reason_counts[3],telemetry->ap_reason_counts[4],telemetry->ap_reason_counts[5],telemetry->ap_reason_counts[6],telemetry->ap_reason_counts[7],telemetry->ap_reason_counts[8]);
    if (ap == 0) {
        switch (code) {
...
int increment_status_count(interop_data_t *telemetry, wifi_status_code_t code, int ap) {
    //wifi_util_dbg_print(WIFI_MON, "%s:%d station_status_counts=[%d:%d:%d:%d:%d:%d] ap_status_counts=[%d:%d:%d:%d:%d:%d]\n",__FUNCTION__,__LINE__,telemetry->sta_status_counts[0],telemetry->sta_status_counts[1],telemetry->sta_status_counts[2],telemetry->sta_status_counts[3],telemetry->sta_status_counts[4],telemetry->sta_status_counts[5],telemetry->ap_status_counts[0],telemetry->ap_status_counts[1],telemetry->ap_status_counts[2],telemetry->ap_status_counts[3],telemetry->ap_status_counts[4],telemetry->ap_status_counts[5]);
    if (ap == 0) {
        switch (code) {
