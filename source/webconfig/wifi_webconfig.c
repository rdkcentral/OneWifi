...
webconfig_error_t webconfig_init(webconfig_t *config)
{
    ...
    strcpy(config->subdocs[webconfig_subdoc_type_sta_manager].name, "sta manager");
    ...
    config->subdocs[webconfig_subdoc_type_sta_manager].translate_to_subdoc = translate_to_levl_subdoc;
    config->subdocs[webconfig_subdoc_type_sta_manager].translate_from_subdoc = translate_from_levl_subdoc;
