...
webconfig_error_t decode_em_policy_object(const cJSON *em_cfg, em_config_t *em_config)
{
    ...
    wifi_util_error_print(WIFI_WEBCONFIG, "%s:%d: em_config->alarm_report_policy.link_stats_alarm_policy_cfg.collection_start_time is %s\n", __func__,
            __LINE__, em_config->alarm_report_policy.collection_start_time);
    wifi_util_error_print(WIFI_WEBCONFIG, "%s:%d: em_config->alarm_report_policy.link_stats_alarm_policy_cfg.reporting_interval is %d\n", __func__,
            __LINE__, em_config->alarm_report_policy.reporting_interval);
    wifi_util_error_print(WIFI_WEBCONFIG, "%s:%d: em_config->alarm_report_policy.link_stats_alarm_policy_cfg.link_quality_threshold is %0.2f\n", __func__,
